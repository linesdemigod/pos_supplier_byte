...
@section('content')
    <x-breadcrumb title="Report" subtitle='Audit By User' name='Audit By User' href='report.index' />
    <div class="py-3">
        <div class="">
            @php
                use Carbon\Carbon;
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="input-group">
                            ...
                            <select name="payment_method" class="form-select form-control-light select_box" id="user">
...
@section('script')
    <script>
        ...
        submitBtn.addEventListener('click', function() {
            ...
            searchUserAuditLog(); // Call the search function
        });

        async function searchUserAuditLog() {
            ...
            try {
                ...
                const res = await axios.get("{{ route('audit.get_user_audit') }}", config)
                const {
                    logs,
                    current_page,
                    last_page
        ...
        document.addEventListener('click', async e => {
            ...
            if (targetElement.classList.contains('view-log') || targetElement.closest('.view-log')) {
                ...
                try {
                    ...
                    const res = await axios.get('{{ route('audit.view_user_audit') }}', config);
