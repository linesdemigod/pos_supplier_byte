...
@section('content')
    <x-breadcrumb title="cash Movement" subtitle='Add cash Movement' name='cash Movement' href='cash_movement.index' />
    <section class="py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card border-1 border">
                        <div class="card-body">
                            <h3 class="py-2 text-center">Add Cash Movement</h3>
                            <form action="{{ route('cash_movement.store') }}" method="Post">
                                @csrf
