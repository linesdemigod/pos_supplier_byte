...
@section('content')
    <x-breadcrumb title="Warehouse Inventory" subtitle='Add Warehouse Inventory' name='Warehouse Inventory'
                ...
                <div class="col-md-6 mx-auto">
                    <div class="card border-1 border">
                        <div class="card-body">
                            ...
                            <form action="{{ route('warehouseinventory.store') }}" method="Post">
                                @csrf
