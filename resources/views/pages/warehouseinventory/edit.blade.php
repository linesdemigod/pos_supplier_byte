...
@endsection
@section('page-id', 'warehouse_inventory')

@section('content')
    <x-breadcrumb title="Warehouse Inventory" subtitle='Update Warehouse Inventory' name='Warehouse Inventory'
        href='warehouseinventory.index' />
    <section class="py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card border-1 border">
                        <div class="card-body">
                            ...
                            <form action="{{ route('warehouseinventory.update', $inventory->id) }}" method="Post">
                                @csrf
                                @method('PUT')
