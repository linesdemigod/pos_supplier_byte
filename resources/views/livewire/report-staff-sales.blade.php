    ...
    <div class="card">
        <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center gap-5">
                    ...
                    <div class="d-flex justify-content-end align-items-end gap-3">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <select name="user" id="selectedUserId" wire:model="selectedUserId"
                                    class="form-select">
            ...
            {{-- <div class="d-flex mt-3 gap-3">
                <div>
                    <p class="fw-semibold">Grandtotal: <span class="text-muted">{{ number_format($grandtotalSum, 2) }}</span>
                    </p>
                </div>
                <div>
                    <p class="fw-semibold">Subtotal: <span class="text-muted">{{ number_format($subtotalSum, 2) }}</span></p>
                </div>
                <div>
                    <p class="fw-semibold">Discount: <span class="text-muted">{{ number_format($discountSum, 2) }}</span></p>
                </div>
                <div>
                    <p class="fw-semibold">Returned Item Total: <span
                            class="text-muted">{{ number_format($itemReturnedSum, 2) }}</span>
                    </p>
                </div>
            </div> --}}
