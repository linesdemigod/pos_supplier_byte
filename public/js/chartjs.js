...
!(function (t, e) {
    ...
    Object.defineProperties(Yn, {
        ...
        version: { enumerable: Xn, value: "3.0.0" },
    ...
    function Ho(t, e, i) {
        ...
        for (let o = 0; o < i.length; o++) {
            const s = i[o],
                { first: a, last: r, point: l } = No(s, e, "x");
            if (!(!l || (a && r)))
                if (a) n.unshift(l);
                    ...
                    for (let t = 0; t < c.length; ++t) {
                        ...
                        for (let t = 0; t < h.length; t++)
                            a.push({
                                source: h[t],
                                target: e,
                                start: { [i]: Xo(l, n, "start", Math.max) },
                                end: { [i]: Xo(l, n, "end", Math.min) },
                            });
                    }
                }
                return a;
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (r = 0; r < n; ++r)
                (a = t.getDatasetMeta(r)),
                    ...
                    s.push(c);
            for (r = 0; r < n; ++r)
                (c = s[r]), c && !1 !== c.fill && (c.fill = $o(s, r, o));
        },
    ...
    class Jo extends Oi {
        ...
        fit() {
            ...
            const n = e.labels,
                ...
                { boxWidth: r, itemHeight: l } = Qo(n, s);
            let c, h;
            (i.font = o.string),
                t.isHorizontal()
        ...
        _draw() {
            ...
            t.drawTitle(),
                ...
                (a.fillStyle = u),
                (a.font = d.string);
            const { boxWidth: x, boxHeight: b, itemHeight: _ } = Qo(l, g),
                y = t.isHorizontal(),
    ...
    var ts = {
        ...
        _element: Jo,
        start(t, e, i) {
            const n = (t.legend = new Jo({ ctx: t.ctx, options: i, chart: t }));
    ...
    class gs extends Oi {
        ...
        getTitle(t, e) {
            ...
            let r = [];
            return (
                (r = os(r, ss(o))), (r = os(r, ss(s))), (r = os(r, ss(a))), r
            );
        }
        getBeforeBody(t, e) {
    ...
    var ps = {
            ...
            positioners: ns,
            afterInit(t, e, i) {
                i && (t.tooltip = new gs({ _chart: t, options: i }));
            },
            beforeUpdate(t, e, i) {
            ...
            return ((t, e) =>
                null === t
                    ...
                    : Ht(
                          ...
                          0,
                          e
                      ))((e = isFinite(e) && i[e] === t ? e : xs(i, t, K(e, t))), i.length - 1);
        }
        determineDataLimits() {
            const t = this,
    ...
    (bs.id = "category"),
        (bs.defaults = { ticks: { callback: bs.prototype.getLabelForValue } });
    class _s extends ji {
        constructor(t) {
            super(t),
                (this.start = void 0),
        ...
        buildTicks() {
            ...
            const o = (function (t, e) {
                ...
                for (
                    ...
                    (i.push({ value: o }),
                    x < o && v++,
                    Tt(Math.round((x + v * y) * m) / m / o, y / 1e3) && v++);
                    v < _;
                    ++v
                )
    ...
    (ys.id = "linear"),
        (ys.defaults = { ticks: { callback: Ei.formatters.numeric } });
    class Ms extends ji {
        constructor(t) {
            super(t),
                (this.start = void 0),
        ...
        buildTicks() {
            const t = this,
                ...
                i = (function (t, e) {
                    ...
                    do {
                        o.push({ value: s, major: vs(s) }),
                            ++r,
                            10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
                            (s = Math.round(r * Math.pow(10, a) * l) / l);
                    } while (a < i || (a === i && r < n));
                    const c = q(t.max, s);
                    return o.push({ value: c, major: vs(s) }), o;
    ...
    class As extends _s {
        ...
        generateTickLabels(t) {
            const e = this;
            _s.prototype.generateTickLabels.call(e, t),
    ...
    class zs extends ji {
        ...
        buildTicks() {
            ...
            return (
                (t._unit =
                    i.unit ||
                    (n.autoSkip
                        ? Es(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
                        : (function (t, e, i, n, o) {
                              for (
                                  let s = Ts.length - 1;
                                  s >= Ts.indexOf(i);
                ...
                (t._majorUnit =
                    n.major.enabled && "year" !== t._unit
                        ? (function (t) {
                              for (
                                  let e = Ts.indexOf(t) + 1, i = Ts.length;
                                  e < i;
                                  ++e
                              )
        ...
        _generate() {
            ...
            return (
                (d !== n && "ticks" !== o.bounds && 1 !== u) || Is(h, d, g),
                Object.keys(h)
                    .sort((t, e) => t - e)
                    .map((t) => +t)
            );
    ...
    return (
        ...
        (Yn.Scale = ji),
        (Yn.Ticks = Ei),
        Object.assign(Yn, co, Ws, Eo, ms, ci),
        (Yn.Chart = Yn),
