...
class WarehouseInventoryImport implements ToCollection, WithChunkReading, WithHeadingRow, WithValidation
    // , SkipsOnError, SkipsOnFailure
{
    ...
    private function insertIntoTable($row)
    {
        ...
        try {
            ...
            $ItemExists = WarehouseInventory::where('warehouse_id', $warehouseId)->where('item_id', $itemId)->exists();

            if ($itemId && !$ItemExists) {
                //insert item
                $data = WarehouseInventory::create([
                    'item_id' => $itemId,
                ...
                $auditTrail = [
                    ...
                    'description' => 'warehouse item creation',
