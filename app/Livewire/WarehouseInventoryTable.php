...
class WarehouseInventoryTable extends Component
{
    ...
    public function delete(WarehouseInventory $inventory)
    {
        ...
        try {
            ...
            session()->flash('message', 'warehouse inventory deleted successfully');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function render()
    {
        ...
        $inventories = WarehouseInventory::with('item.category')
            ->where('warehouse_id', $warehouseId)
            ->search($this->search)
            ->latest()
            ->paginate($this->perPage);

        return view('livewire.warehouse-inventory-table', [
